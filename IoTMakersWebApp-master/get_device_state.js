...
var invokeAPI = function() {
    ...
    var API_URI = 'https://enofhtr857.execute-api.ap-northeast-2.amazonaws.com/prod/devices/Subway408_4';                 
    $.ajax(API_URI, {
        method: 'GET',
...
var printData = function(result){      
    document.getElementById("result").innerHTML = "PressureSensor: "+ result.state.reported.PressureSensor +  
