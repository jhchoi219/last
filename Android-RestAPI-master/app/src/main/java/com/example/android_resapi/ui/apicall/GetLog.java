...
public class GetLog extends GetRequest {
    ...
    protected ArrayList<Tag> getArrayListFromJSONString(String jsonString) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Tag thing = new Tag(jsonObject.getString("PressureSensor"),
    ...
    class Tag {
        ...
        public Tag(String PressureSensor, String Rfid, String LED, String time) {
            Press = PressureSensor;
            timestamp = time;
        }

        public String toString() {
            return String.format("[%s] PressureSensor: %s", timestamp, Press);
        }
    }
}
