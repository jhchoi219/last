...
public class GetThingShadow extends GetRequest {
    ...
    protected void onPostExecute(String jsonString) {
        ...
        TextView reported_RfidTV = activity.findViewById(R.id.reported_Rfid);
        reported_ledTV.setText(state.get("reported_LED"));
        reported_RfidTV.setText(state.get("reported_Rfid"));

        TextView desired_ledTV = activity.findViewById(R.id.desired_LED);
        TextView desired_RfidTV = activity.findViewById(R.id.desired_Rfid);
        desired_ledTV.setText(state.get("desired_LED"));
        desired_RfidTV.setText(state.get("desired_Rfid"));
